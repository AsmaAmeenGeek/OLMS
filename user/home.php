...
<body>
    ...
    <section class="home_content">
        ...
        <div class="about-library">
            <h2>Welcome to Our Million ...!</h2>
            <p>At Million Library, we believe in making reading accessible and fun for everyone! Our library management
                system is designed to streamline your experience, making it easier than ever to reserve, renew, and
                return books. Say goodbye to the old ways of library management and hello to a new era of convenience!
                Our team of dedicated students has crafted this system as part of our university project, and we’re
                excited to share it with you. We’re not just a library; we’re a community of book lovers, and we want
                you to be a part of it!
                With features that allow users to send requests and receive messages from admins, we’re here to ensure
                that your library experience is smooth and enjoyable. Dive into the world of books with us!</p>
        </div>
    </section>
    </div>
